...
import {
  ...
  CP_BEIGE_COD_50, CP_GRAY_200, CP_GRAY_600, CP_GRAY_700, CP_GRAY_900,
  ...
  CP_ERROR, CP_SUCCESS, CP_SUCCESS_BG, CP_BANNER_RED,
  CpIco, CpLayout, CpButton, CpStatusBadge,
} from './lp-ui';
...
/* ─────────────  LOGIN  ───────────── */
export function LpClientLogin({ onLogin, onAdmin }) {
...
export function LpClientBanner({ banner }) {
      ...
      <div data-screen-label="01 Новая заявка" style={{
        ...
        <div className="cp-form-container" style={{ display:'flex', alignItems:'flex-start', padding:'0 32px', gap:32 }}>
          ...
          <div style={{ flex:1, minWidth:0, display:'flex', flexDirection:'column', alignItems:'flex-start', gap:20 }}>
            ...
            <div className="content-parent" style={{ width:760, maxWidth:'100%', alignSelf:'stretch', display:'flex', alignItems:'flex-start', gap:32 }}>
              ...
              <div style={{ flex:1, minWidth:0, display:'flex', flexDirection:'column', gap:8 }}>
                <div style={{ fontFamily:CP_F, fontWeight:500, fontSize:14, lineHeight:'20px', color:CP_TEXT_PRIMARY }}>Способ получения</div>
                <div style={{
              ...
              <div style={{ flex:1, minWidth:0, display:'flex', flexDirection:'column', gap:8, position:'relative' }}>
                <div style={{ fontFamily:CP_F, fontWeight:500, fontSize:14, lineHeight:'20px', color:CP_TEXT_PRIMARY }}>Дата отгрузки</div>
            ...
            <div className="content13" style={{ width:760, maxWidth:'100%', display:'flex', flexDirection:'column', gap:8 }}>
              <div style={{ fontFamily:CP_F, fontWeight:500, fontSize:14, lineHeight:'20px', color:CP_TEXT_PRIMARY }}>Комментарий к заказу</div>
              <textarea
                value={comment}
          ...
          <aside className="cp-order-summary" style={{ width:292, flexShrink:0, paddingTop:58, position:'sticky', top:32, display:'flex', flexDirection:'column', gap:12 }}>
            <div style={{
              ...
              <div style={{ padding:20, display:'flex', flexDirection:'column', alignItems:'center', gap:24, background:'#fff', borderRadius:8 }}>
                ...
                <div style={{ alignSelf:'stretch', display:'flex', flexDirection:'column', gap:16 }}>
                  <div style={{ fontFamily:CP_FD, fontWeight:500, fontSize:16, lineHeight:'24px', letterSpacing:'0.15px', color:CP_TEXT_SECONDARY }}>Итог заказа</div>
            ...
            <div style={{
              alignSelf:'stretch', padding:16, gap:12, borderRadius:12,
              background:CP_CREAM, border:`1px solid ${CP_BEIGE_500}`,
              ...
              <div style={{ fontFamily:CP_F, fontWeight:600, fontSize:14, lineHeight:'20px', color:CP_TEXT_ALERT }}>Заявки принимаются до 15:00 — отгрузка через 2 рабочих дня</div>
            </div>
          </aside>
        </div>
      </div>
...
/* Позиция заказа — новый дизайн Figma */
    ...
    <div style={{ alignSelf:'stretch', display:'flex', flexDirection:'column', gap:16 }}>
      <div className="frame-parent" style={{ alignSelf:'stretch', display:'flex', alignItems:'center', gap:16 }}>
        <div className="input-dropdown-parent" style={{
          ...
          {/* Тара + Stepper */}
          <div className="input-dropdown-group" style={{ flex:1, minWidth:0, display:'flex', alignItems:'center', gap:12 }}>
            <div style={{ flex:1, minWidth:0, display:'flex', flexDirection:'column' }}>
      ...
      <div className="cp-hist-page" style={{ width:'100%', maxWidth:1148, margin:'0 auto', padding:'32px 32px 48px', display:'flex', flexDirection:'column', gap:32 }}>
        ...
        <div className="cp-hist-filters" style={{
          ...
          <button type="button" onClick={clearFilters} className="cp-hist-clear"
            style={{
              ...
              padding:'10px 18px', boxShadow:HIST_SHADOW_INPUT, flex:'0 0 auto',
          ...
          {filtered.map(order => {
            ...
            return (
              <div key={order.id} style={{
                background:'#fff', border:`1px solid ${HIST_BORDER_CARD}`, borderRadius:16, overflow:'hidden',
              }}>
        ...
        {filtered.length > 0 && (
          <div className="cp-hist-pagination" style={{
            borderTop:`1px solid ${HIST_BORDER_DIVIDER}`, paddingTop:20,
...
/* ─────────────  404  ───────────── */
export function Lp404({ onBack, onHome }) {
  return (
    <div style={{
      minHeight:'100vh', background:CP_CREAM, fontFamily:CP_F,
